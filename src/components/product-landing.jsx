...
const THREADS = {
  companion: {
    ...
    msgs: [
      ...
      {
        who: "ai",
        t: "可以这样理解：能用语言说清楚的「道」，就已经不是那个恒常的、根本的道了。老子一上来就提醒你——真正的道超出语言。",
        ref: "道德经 · 第一章",
      },
      { who: "user", t: "那读它还有意义吗？" },
      {
        who: "ai",
        t: "有。语言是指月的手指。读下去你会发现，他用「水」「婴儿」「谷」一类比喻，反复绕着那个说不尽的东西——这正是读《道德经》的乐趣。",
      },
    ],
  },
  extend: {
    ...
    msgs: [
      ...
      {
        who: "ai",
        t: "它在道家里反复出现。庄子把它推得更远——「无为而无不为」。如果你感兴趣，馆里的《庄子·逍遥游》正好接着讲。",
        ref: "↗ 跳转：庄子 · 逍遥游",
      },
      {
        who: "ai",
        t: "换个视角，亚当·斯密「看不见的手」也有几分「无为」的影子：不刻意干预，秩序自然生成。要不要对照读一段《国富论》？",
        ref: "↗ 跳转：国富论 · 第四篇",
      },
    ],
  },
  ...
  debate: {
    ...
    msgs: [
      ...
      {
        who: "ai",
        t: "那我问你：农夫不拔苗助长，是「什么都不做」，还是恰恰做了最该做的事？",
        ref: "反问 · 苏格拉底式",
      },
      { who: "user", t: "……好像是顺应规律地做。" },
      {
        who: "ai",
        t: "对。那么「无为」究竟是不作为，还是「不妄为」？这两者的差别，可能正是老子想让你停下来想的地方。",
      },
    ],
  },
};
  ...
  return (
    <div className="landing" ref={rootRef}>
          ...
          <div className="hero-grid">
            <div>
              ...
              <h1 className="display-xl reveal d1">
                永远
                <br />
                <span className="serif-it">不会丢失</span>
                <br />
                的图书馆<span className="seal">.</span>
              </h1>
              <p className="lede reveal d2">
                人类的公共知识，本就属于所有人。Liber 把它们永久写入去中心化网络，配上一位真正懂书的
              ...
              <div className="hero-stats reveal d4">
                <div>
                  <div className="n">永久</div>
                  <div className="l">Walrus · Arweave 存储</div>
                </div>
                <div>
                  <div className="n">CC0</div>
                  <div className="l">公共版权 · 自由传播</div>
                </div>
                <div>
                  <div className="n">100%</div>
                  <div className="l">开源 · 社区共建</div>
                </div>
              </div>
            </div>
            <div className="hero-art reveal d2">
              {HERO_COVERS.map((c) => (
                <div className={`cover ${c.cls} ${c.pos}`} key={c.pos}>
                  ...
                  <div>
                    <div className="c-title" style={{ fontSize: c.size }}>
                      {c.title}
                    </div>
                    <div className="c-author" style={{ marginTop: 8 }}>
                      {c.author}
                    </div>
                  </div>
      ...
      <section className="sec" id="discover">
        <div className="wrap">
          <div className="sec-head reveal">
            ...
            <p className="sub">
              每一本都是公共领域的经典，每一本都已永久上链。挑一本，开始读——无需付费，无需许可。
            </p>
          </div>
            ...
            <div className="frame-bar">
              ...
              <span className="url">
                ...
                <span style={{ opacity: 0.6 }}>
                  · {catalogTotal.toLocaleString("zh-CN")} 卷已入库
                </span>
              </span>
            </div>
        ...
        <div className="wrap">
          <div className="sec-head reveal">
            ...
            <h2 className="display-l">
              这些书为什么能
              <br />
              自由地读、<span className="serif-it">自由地传</span>？
            </h2>
            <p className="sub">
              因为它们属于<b>公共领域（Public Domain）</b>
              ——人类共同的知识遗产。版权终会到期，思想终将回到所有人手中。Liber
              做的，是把这份遗产收好、存住、讲清楚。
            </p>
          </div>
          <div className="role-grid reveal d1">
            <div className="role-card">
              <div className="rc-no">01 / 版权会到期</div>
              <h3>保护，但不是永远</h3>
              <p>
                著作权保护有期限。作者离世若干年后（多数国家是 50–70
                年），作品自动进入公共领域，任何人都能自由使用——这是法律本来的设计。
              </p>
            </div>
            <div className="role-card">
              <div className="rc-no">02 / 属于所有人</div>
              <h3>进入公共领域 = 属于你我</h3>
              <p>
                《道德经》《国富论》《沉思录》……这些塑造了文明的书，早已不属于任何个人或公司。复制、翻译、改编、再创作，都无需付费、无需许可。
              </p>
            </div>
            <div className="role-card">
              <div className="rc-no">03 / CC0 再确认</div>
              <h3>我们以 CC0 重新交付</h3>
              <p>
                对自己整理、转写、生成的部分，Liber 一律用 CC0
                公共领域贡献声明放弃权利。拿来即用，永不反悔——和我们收藏的经典一样自由。
              </p>
            </div>
          </div>
          <div
          ...
          >
            ...
            >
              读全文：什么是公共领域知识 <span className="arr">→</span>
            </button>
        ...
        <div className="wrap">
          <div className="landing-news-head reveal">
            <div className="sec-head">
              ...
              <p className="sub">
                公共领域、上架公告、协议设计与产品进展都会在这里公开。原创内容同样以 CC0
                发布，可自由转载、翻译、改编。
              </p>
            </div>
        ...
        <div className="wrap">
          <div className="perm-grid">
            <div className="reveal">
              ...
              <p className="sub" style={{ maxWidth: "42ch" }}>
                Liber 不把书存在某家公司的服务器上。每一卷的正文都写入{" "}
                <b>Walrus（Sui 上的去中心化存储）</b> 与 <b>Arweave</b>，索引结构记录在 <b>Sui</b>{" "}
                链上。没有谁能单方面删除它——包括我们自己。
              </p>
              <div style={{ marginTop: 28 }}>
                <span className="badge-perm">◇ 一次写入 · 永久可读</span>
              </div>
            </div>
            <div className="reveal d1">
              <div className="stack">
                <div className="layer">
                  ...
                  <div className="ltxt">
                    <div className="lt">正文内容</div>
                    <div className="ld">书页原文，分块寻址存储</div>
                  </div>
                  <div className="ltag">Walrus</div>
                </div>
                <div className="layer">
                  <div className="lnum">02</div>
                  <div className="ltxt">
                    <div className="lt">冷备份</div>
                    <div className="ld">永久副本，跨网络冗余</div>
                  </div>
                  <div className="ltag">Arweave</div>
                </div>
                <div className="layer">
                  <div className="lnum">03</div>
                  <div className="ltxt">
                    <div className="lt">索引 / 元数据</div>
                    <div className="ld">书目、章节、划线、热度</div>
                  </div>
                  <div className="ltag">Sui</div>
                </div>
              </div>
              <div className="proof" style={{ marginTop: 18 }}>
                <div className="ph">道德经 · 存证</div>
                <div className="pr">
                  <span className="k">blob_id</span>
                  <span className="v">walrus://0x8f3a…d21c</span>
                </div>
                <div className="pr">
                  <span className="k">backup</span>
                  <span className="v">ar://Qd9_kP…7Lm</span>
                </div>
                <div className="pr">
                  <span className="k">index</span>
                  <span className="v">sui::registry::Book#0427</span>
                </div>
                <div className="pr">
                  <span className="k">status</span>
                  <span className="v">
                    <span className="ok">● 已永久存证</span>
                  </span>
                </div>
              </div>
            </div>
      ...
      <section className="sec" id="ai">
        <div className="wrap">
          <div className="sec-head reveal">
            ...
            <p className="sub">
              不是冷冰冰的问答框。Liber 的 AI
              读过同一本书，知道你读到了哪一页——你划一句、问一句，它就在书页旁边接上话。
            </p>
          </div>
            ...
            <div className="read-grid">
              <div className="read-pane">
                ...
                <div className="r-body">
                  <p>
                    <span className="hl">道可道，非常道；名可名，非常名。</span>
                  </p>
                  <p>无名天地之始，有名万物之母。故常无欲，以观其妙；常有欲，以观其徼。</p>
                  <p>
                    此两者，同出而异名，同谓之玄。<span className="hl-people">玄</span>
                    之又玄，众妙之门。
                  </p>
                </div>
              </div>
          ...
          <div className="role-grid reveal d1">
            <div className="role-card">
              <div className="rc-no">01 / 陪伴</div>
              <h3>像一个边读边聊的书友</h3>
              <p>
                读到哪、卡在哪，它都知道。用你能听懂的话把难句讲开，不剧透后文，陪你一章一章走完。
              </p>
            </div>
            <div className="role-card">
              <div className="rc-no">02 / 延展</div>
              <h3>把概念连到更大的世界</h3>
              <p>
                「无为」在庄子里怎么说？亚当·斯密的「看不见的手」又是什么？一键跳到馆里的相关书与段落。
              </p>
            </div>
            <div className="role-card">
              <div className="rc-no">03 / 笔记</div>
              <h3>自动生成摘要与读书笔记</h3>
              <p>
                每读完一章，自动整理脉络、金句与你的划线，存成可导出的笔记。回头复习，几分钟唤回整本书。
              </p>
            </div>
            <div className="role-card">
              <div className="rc-no">04 / 思辨</div>
              <h3>苏格拉底式地与你过招</h3>
              <p>
                不只解释，还会质疑。对书中的观点提出反问，逼你想得更深——把读书变成一场对话，而非灌输。
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="sec" id="social" style={{ background: "var(--paper-2)" }}>
        ...
        <div className="wrap">
          <div className="sec-head reveal">
            ...
            <p className="sub">
              书页的边缘从不安静。在
              Liber，你能看见别人在同一句话旁写下的批注、被划得最多的句子，甚至别人和 AI
              的精彩对话。
            </p>
          </div>
          <div className="soc-grid">
            <div className="card col-7 reveal d1">
              ...
              <p style={{ marginBottom: 6 }}>
                选中任意一句，写下批注。其他读者读到同一句时，能看见你的想法。
              </p>
              <div className="anno-quote">
                「<span className="marked">天下皆知美之为美，斯恶已。</span>」
                <span className="muted" style={{ fontSize: 15, fontStyle: "normal" }}>
                  — 道德经 · 第二章
                </span>
              </div>
              <div className="note">
                <div className="ava" style={{ background: "#3a4fb0" }}>
                  读
                </div>
                <div className="nb">
                  <div className="nm">读者批注</div>
                  <div className="tx">
                    美与丑是同时被定义出来的——一旦立了标准，对立面就跟着诞生了。
                  </div>
                  <div className="mt">赞同与回复来自真实读者</div>
                </div>
              </div>
              <div className="note">
                <div className="ava" style={{ background: "var(--accent)" }}>
                  AI
                </div>
                <div className="nb">
                  <div className="nm">书友 · AI</div>
                  <div className="tx">
                    这正是老子的「相对」观。可与第二章后文「有无相生，难易相成」连起来读。
                  </div>
                  <div className="mt">可收藏进笔记</div>
                </div>
              </div>
            </div>
            <div className="card col-5 reveal d2">
              ...
              <div style={{ marginTop: 18 }}>
                <div className="hi-row">
                  ...
                  <div>
                    <div className="q">「知人者智，自知者明。」</div>
                    <div className="c">真实划线产生后更新排行</div>
                  </div>
                </div>
                <div className="hi-row">
                  <div className="rank">2</div>
                  <div>
                    <div className="q">「我们感受到的不是事物本身，而是我们对它的看法。」</div>
                    <div className="c">真实划线产生后更新排行</div>
                  </div>
                </div>
                <div className="hi-row">
            ...
            <div
              className="card col-12 reveal d1"
              style={{
                display: "grid",
            ...
            >
              <div>
                ...
                <p>
                  你和 AI
                  书友聊出的精彩片段，可以一键公开。其他人能浏览、收藏，甚至接着这段对话继续追问——知识在对话里生长。
                </p>
                <div style={{ marginTop: 18 }}>
                  <span className="badge-perm">↗ 公开分享 · 可被 Agent 引用</span>
                </div>
              </div>
              <div
                className="ai-thread"
              ...
              >
                ...
                <div className="bub ai">
                  <div className="who">书友 · AI</div>
                  恰恰相反。他想说的是：个人追求自利，在竞争市场里会<b>无意中</b>
                  促进公共利益——这是结果，不是动机的辩护。
                  <div className="ref">国富论 · 第四篇 第二章</div>
                </div>
                <div className="bub user">那它什么时候会失灵？</div>
                <div className="bub ai">
                  <div className="who">书友 · AI</div>好问题。当存在垄断、外部性或信息不对称时……
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="sec" id="open">
        <div className="wrap">
          <div className="sec-head reveal" style={{ maxWidth: 820 }}>
            ...
            <p className="sub">
              微信读书是一座封闭的花园。Liber 反过来：内容、索引、数据全部开放。AI Agent 可以通过
              MCP 直接读取书目与阅读数据，把整座图书馆当作工具来用。
            </p>
          </div>
          <div className="agent-grid" style={{ marginTop: 48 }}>
            <div className="reveal d1">
              <ul className="feat-list">
                <li>
                  ...
                  <span>
                    <b>全部开源。</b> 协议、索引、客户端代码公开可审计，社区共建，可自托管。
                  </span>
                </li>
                <li>
                  <span className="fi">◆</span>
                  <span>
                    <b>数据可读（MCP）。</b> 阅读量、热门划线、畅销度等后台数据，通过 MCP
                    标准化暴露给 Agent。
                  </span>
                </li>
                <li>
                  <span className="fi">◆</span>
                  <span>
                    <b>内容即接口。</b> 每一卷书都有稳定的链上地址，Agent 可直接定位到章节与段落。
                  </span>
                </li>
                <li>
                  <span className="fi">◆</span>
                  <span>
                    <b>无抽成、无下架。</b> CC0 内容自由流通，没有平台从中抽水，也没人能让它消失。
                  </span>
                </li>
              </ul>
            </div>
            <div className="reveal d2">
              <div className="term">
                ...
                <div className="tbody">
                  <div className="cmd">
                    <span className="pr">agent ❯</span> liber.query(
                    <span className="str">"最畅销的哲学公版书"</span>)
                  </div>
                  <div className="out" style={{ margin: "6px 0 14px" }}>
                    → 通过 MCP 读取链上索引…
                  </div>
                  <div className="out">{"{"}</div>
                  <div className="out">
                    &nbsp;&nbsp;<span className="key">"title"</span>:{" "}
                    <span className="str">"{agentBook.t}"</span>,
                  </div>
                  <div className="out">
                    &nbsp;&nbsp;<span className="key">"reads_30d"</span>:{" "}
                    <span className="str">{agentBook.reads || "0"}</span>,
                  </div>
                  <div className="out">
                    &nbsp;&nbsp;<span className="key">"chapters"</span>:{" "}
                    <span className="str">{agentBook.pages || 0}</span>,
                  </div>
                  <div className="out">
                    &nbsp;&nbsp;<span className="key">"blob"</span>:{" "}
                    <span className="str">"{agentBook.blob || "pending"}"</span>,
                  </div>
                  <div className="out">
                    &nbsp;&nbsp;<span className="key">"license"</span>:{" "}
                    <span className="str">"{licenseLabel(agentBook.license)}"</span>
                  </div>
                  <div className="out">{"}"}</div>
                  <div className="cmd" style={{ marginTop: 12 }}>
                    <span className="pr">agent ❯</span> <span style={{ opacity: 0.5 }}>▍</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="perm-grid">
            <div className="reveal">
              ...
              <p className="sub" style={{ maxWidth: "44ch" }}>
                <b>经典图谱</b>（Classical
                Atlas）以六十四卦为主干，向外牵起道家、儒家、佛家与西方系统思维。星图导航、卦象立体可视化、逐句注解、跨文本互引——把彼此呼应的经典，连成一张可游走的网络。
              </p>
              <div
                className="reveal d1"
                style={{
              ...
              >
                <a
                  className="btn btn-primary"
                  href="https://yijing.davirain.xyz/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  前往经典图谱 <span className="arr">↗</span>
                </a>
            ...
            <div className="reveal d1">
              <div className="stack">
                <div className="layer">
                  <div className="lnum">易</div>
                  <div className="ltxt">
                    <div className="lt">易经 · 六十四卦</div>
                    <div className="ld">全卦经文、十翼与白话注解</div>
                  </div>
                  <div className="ltag">主干</div>
                </div>
                <div className="layer">
                  <div className="lnum">道</div>
                  <div className="ltxt">
                    <div className="lt">道家</div>
                    <div className="ld">道德经、庄子等</div>
                  </div>
                  <div className="ltag">7 部</div>
                </div>
                <div className="layer">
                  <div className="lnum">儒</div>
                  <div className="ltxt">
                    <div className="lt">儒家</div>
                    <div className="ld">中庸、阳明心学等</div>
                  </div>
                  <div className="ltag">5 部</div>
                </div>
                <div className="layer">
                  <div className="lnum">释</div>
                  <div className="ltxt">
                    <div className="lt">佛家</div>
                    <div className="ld">心经、金刚经、坛经等</div>
                  </div>
                  <div className="ltag">7 部</div>
                </div>
                <div className="layer">
                  <div className="lnum">西</div>
                  <div className="ltxt">
                    <div className="lt">西方系统思维</div>
                    <div className="ld">群论等跨文化对照</div>
                  </div>
                  <div className="ltag">9 项</div>
                </div>
              </div>
              <div style={{ marginTop: 18 }}>
                <span className="badge-perm">◇ 星图导航 · 卦象可视化 · 全文检索</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="cta" id="join">
        <div className="wrap">
          <span className="kicker center reveal" style={{ display: "flex" }}>
            加入早期共建
          </span>
          <h2 className="big reveal d1" style={{ marginTop: 22 }}>
            一座
            <span className="serif-it" style={{ color: "var(--accent)" }}>
              不灭
            </span>
        ...
        <div className="wrap">
          <div className="foot-grid">
            <div className="foot-col">
              ...
              >
                <Mark size={26} />
                <span className="word" style={{ fontSize: 22 }}>
                  Liber
                </span>
              </a>
              <p className="muted" style={{ fontSize: 15, maxWidth: "30ch" }}>
                人类的公共知识，永久、开放、对 AI 友好。一座不会丢失的图书馆。
              </p>
            </div>
            <div className="foot-col">
              <h4>探索</h4>
              ...
              <a href="#ai">AI 书友</a>
              <a href="#social">共读</a>
              <a href="#collection">馆藏</a>
              <a href="#news">动态</a>
            </div>
            <div className="foot-col">
              <h4>协议</h4>
              <a href="#permanence">Walrus 存储</a>
              <a href="#permanence">Arweave 备份</a>
              <a href="#permanence">Sui 索引</a>
              <a href="#open">MCP 接口</a>
            </div>
            <div className="foot-col">
              <h4>社区</h4>
